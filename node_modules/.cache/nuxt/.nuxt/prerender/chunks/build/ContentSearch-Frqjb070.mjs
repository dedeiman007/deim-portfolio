import { useSlots, useModel, computed, useTemplateRef, mergeProps, unref, isRef, withCtx, createSlots, renderList, renderSlot, createVNode, mergeModels, ref, toValue, toRef, toHandlers, createTextVNode, toDisplayString, openBlock, createBlock, createCommentVNode, Fragment, withKeys, useSSRContext } from 'file:///Users/deim/Documents/project-viet/deim-portfolio/node_modules/vue/index.mjs';
import { ssrRenderComponent, ssrRenderSlot, ssrInterpolate, ssrRenderClass, ssrRenderList, ssrRenderAttrs } from 'file:///Users/deim/Documents/project-viet/deim-portfolio/node_modules/vue/server-renderer/index.mjs';
import { useForwardProps, useForwardPropsEmits, DialogRoot, DialogContent, VisuallyHidden, DialogTitle, DialogDescription, DialogClose, DialogTrigger, DialogPortal, DialogOverlay, ListboxItem, ListboxItemIndicator, ListboxRoot, ListboxFilter, ListboxContent, ListboxVirtualizer, ListboxGroup, ListboxGroupLabel, Primitive } from 'file:///Users/deim/Documents/project-viet/deim-portfolio/node_modules/reka-ui/dist/index.js';
import { defu } from 'file:///Users/deim/Documents/project-viet/deim-portfolio/node_modules/defu/dist/defu.mjs';
import { b as useLocale, E as useColorMode, u as useAppConfig, d as useComponentUI, r as reactivePick, t as tv, F as transformUI, w as omit, a as createSharedComposable, A as useDebounceFn, B as useKbd, C as useEventListener, e as usePortal, p as pointerDownOutside, f as createReusableTemplate, _ as _sfc_main$l, q as refThrottled, s as _sfc_main$m, v as pickLinkProps, g as get, x as _sfc_main$n, m as _sfc_main$r, n as _sfc_main$o, y as _sfc_main$p, z as _sfc_main$b, D as useActiveElement, h as useVModel, j as useFormField, k as useFieldGroup, l as useComponentIcons, o as looseToNumber } from './server.mjs';
import { useFuse } from 'file:///Users/deim/Documents/project-viet/deim-portfolio/node_modules/@vueuse/integrations/dist/useFuse.js';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(DefineItemTemplate), null, {
        default: withCtx(({ item, index, group }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_sfc_main$m, mergeProps(unref(pickLinkProps)(item), { custom: "" }), {
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(unref(ListboxItem), {
                    ...
                    default: withCtx((_, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(_sfc_main$n, mergeProps(slotProps, {
                          "data-slot": "item",
                            ...
                            if (_push5) {
                              ssrRenderSlot(_ctx.$slots, item.slot || group?.slot || "item", {
                                ...
                                ssrRenderSlot(_ctx.$slots, item.slot ? `${item.slot}-leading` : group?.slot ? `${group.slot}-leading` : `item-leading`, {
                                  ...
                                  if (item.loading) {
                                    _push5(ssrRenderComponent(_sfc_main$r, {
                                ...
                                renderSlot(_ctx.$slots, item.slot || group?.slot || "item", {
                                  ...
                                  renderSlot(_ctx.$slots, item.slot ? `${item.slot}-leading` : group?.slot ? `${group.slot}-leading` : `item-leading`, {
                                    ...
                                    item.loading ? (openBlock(), createBlock(_sfc_main$r, {
                                      ...
                                      "data-slot": "itemLeadingAvatar",
                                      class: ui.value.itemLeadingAvatar({ class: [unref(uiProp)?.itemLeadingAvatar, item.ui?.itemLeadingAvatar], active: active || item.active })
                                    }), null, 16, ["size", "class"])) : item.chip ? (openBlock(), createBlock(_sfc_main$p, mergeProps({
                                      key: 3,
                                      size: item.ui?.itemLeadingChipSize || unref(uiProp)?.itemLeadingChipSize || ui.value.itemLeadingChipSize(),
                                      inset: "",
                                      standalone: ""
                                  ...
                                  createVNode("span", {
                                    ...
                                    renderSlot(_ctx.$slots, item.slot ? `${item.slot}-trailing` : group?.slot ? `${group.slot}-trailing` : `item-trailing`, {
                                      ...
                                      item.children && item.children.length > 0 ? (openBlock(), createBlock(_sfc_main$r, {
                                        key: 0,
                                        name: __props.childrenIcon || unref(appConfig).ui.icons.chevronRight,
                                        "data-slot": "itemTrailingIcon",
                                        class: ui.value.itemTrailingIcon({ class: [unref(uiProp)?.itemTrailingIcon, item.ui?.itemTrailingIcon] })
                                      ...
                                      ], 2)) : group?.highlightedIcon ? (openBlock(), createBlock(_sfc_main$r, {
                                        key: 2,
                                        name: group.highlightedIcon,
                                        "data-slot": "itemTrailingHighlightedIcon",
                                        class: ui.value.itemTrailingHighlightedIcon({ class: [unref(uiProp)?.itemTrailingHighlightedIcon, item.ui?.itemTrailingHighlightedIcon] })
            ...
            return [
              createVNode(_sfc_main$m, mergeProps(unref(pickLinkProps)(item), { custom: "" }), {
                        ...
                        fn: withCtx((_3, _push4, _parent4, _scopeId3) => {
                          if (_push4) {
                            ssrRenderSlot(_ctx.$slots, "back", { ui: ui.value }, () => {
                              _push4(ssrRenderComponent(_sfc_main$l, mergeProps({
                                size: __props.size,
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/@nuxt/ui/dist/runtime/components/content/ContentSearch.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=ContentSearch-Frqjb070.mjs.map
