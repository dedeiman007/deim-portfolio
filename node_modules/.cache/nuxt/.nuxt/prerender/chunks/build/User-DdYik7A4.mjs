import { useSlots, computed, unref, mergeProps, withCtx, createVNode, renderSlot, openBlock, createBlock, createCommentVNode, createTextVNode, toDisplayString, useSSRContext } from 'file:///Users/deim/Documents/project-viet/deim-portfolio/node_modules/vue/index.mjs';
...
import { u as useAppConfig, d as useComponentUI, t as tv, y as _sfc_main$p, n as _sfc_main$o, s as _sfc_main$m } from './server.mjs';
          ...
          if (_push2) {
            ssrRenderSlot(_ctx.$slots, "avatar", { ui: ui.value }, () => {
              if (__props.chip && __props.avatar) {
                _push2(ssrRenderComponent(_sfc_main$p, mergeProps({ inset: "" }, typeof __props.chip === "object" ? __props.chip : {}, { size: __props.size }), {
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(ssrRenderComponent(_sfc_main$o, mergeProps({ alt: __props.name }, __props.avatar, {
                        size: __props.size,
                        "data-slot": "avatar",
                      ...
                      return [
                        createVNode(_sfc_main$o, mergeProps({ alt: __props.name }, __props.avatar, {
                          size: __props.size,
                          "data-slot": "avatar",
                          class: ui.value.avatar({ class: unref(uiProp)?.avatar })
                ...
                _push2(ssrRenderComponent(_sfc_main$o, mergeProps({ alt: __props.name }, __props.avatar, {
                  size: __props.size,
                  "data-slot": "avatar",
                  class: ui.value.avatar({ class: unref(uiProp)?.avatar })
            ...
            if (__props.to) {
              _push2(ssrRenderComponent(_sfc_main$m, mergeProps({ "aria-label": __props.name }, { to: __props.to, target: __props.target, ..._ctx.$attrs }, {
            ...
            ssrRenderSlot(_ctx.$slots, "default", {}, () => {
              if (__props.name || !!slots.name) {
                _push2(`<p data-slot="name" class="${ssrRenderClass(ui.value.name({ class: unref(uiProp)?.name }))}"${_scopeId}>`);
            ...
            return [
              renderSlot(_ctx.$slots, "avatar", { ui: ui.value }, () => [
                __props.chip && __props.avatar ? (openBlock(), createBlock(_sfc_main$p, mergeProps({
                  key: 0,
                  inset: ""
                  ...
                  _: 1
                }, 16, ["size"])) : __props.avatar ? (openBlock(), createBlock(_sfc_main$o, mergeProps({
                  key: 1,
                  alt: __props.name
                }, __props.avatar, {
                  size: __props.size,
...
//# sourceMappingURL=User-DdYik7A4.mjs.map
