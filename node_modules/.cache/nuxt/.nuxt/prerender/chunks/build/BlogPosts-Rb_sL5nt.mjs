import { useSlots, computed, unref, mergeProps, withCtx, createSlots, renderList, renderSlot, openBlock, createBlock, Fragment, createVNode, resolveDynamicComponent, createCommentVNode, createTextVNode, toDisplayString, provide, useSSRContext } from 'file:///Users/deim/Documents/project-viet/deim-portfolio/node_modules/vue/index.mjs';
import { ssrRenderComponent, ssrRenderSlot, ssrRenderList, ssrRenderClass, ssrRenderVNode, ssrRenderAttr, ssrInterpolate } from 'file:///Users/deim/Documents/project-viet/deim-portfolio/node_modules/vue/server-renderer/index.mjs';
import { Primitive, useDateFormatter } from 'file:///Users/deim/Documents/project-viet/deim-portfolio/node_modules/reka-ui/dist/index.js';
import { u as useAppConfig, d as useComponentUI, t as tv, b as useLocale, P as getSlotChildrenText, K as ImageComponent, s as _sfc_main$m, S as _sfc_main$d, n as _sfc_main$o, w as omit, R as avatarGroupInjectionKey } from './server.mjs';
import { _ as _sfc_main$3 } from './User-DdYik7A4.mjs';
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    const ui = computed(() => tv({ extend: tv(theme$2), ...appConfig.ui?.avatarGroup || {} })({
      size: props.size
    }));
      ...
      _push(ssrRenderComponent(unref(Primitive), mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [
              hiddenCount.value > 0 ? (openBlock(), createBlock(_sfc_main$o, {
                key: 0,
                text: `+${hiddenCount.value}`,
                "data-slot": "base",
                class: ui.value.base({ class: unref(uiProp)?.base })
          ...
          if (_push2) {
            if (__props.image || !!slots.header) {
              ...
              ssrRenderSlot(_ctx.$slots, "header", { ui: ui.value }, () => {
                ssrRenderVNode(_push2, createVNode(resolveDynamicComponent(unref(ImageComponent)), mergeProps(typeof __props.image === "string" ? { src: __props.image, alt: __props.title } : { alt: __props.title, ...__props.image }, {
                  "data-slot": "image",
                  class: ui.value.image({ class: unref(uiProp)?.image, to: !!__props.to })
                }), null), _parent2, _scopeId);
            ...
            ssrRenderSlot(_ctx.$slots, "body", {}, () => {
              if (date.value || !!slots.date || (__props.badge || !!slots.badge)) {
                _push2(`<div data-slot="meta" class="${ssrRenderClass(ui.value.meta({ class: unref(uiProp)?.meta }))}"${_scopeId}>`);
                ssrRenderSlot(_ctx.$slots, "badge", {}, () => {
                  if (__props.badge) {
                    _push2(ssrRenderComponent(_sfc_main$d, mergeProps({
                      ...
                      "data-slot": "badge",
                      class: ui.value.badge({ class: unref(uiProp)?.badge })
                    }), null, _parent2, _scopeId));
                  } else {
                    _push2(`<!---->`);
                  }
                ...
                if (date.value || !!slots.date) {
                  _push2(`<time${ssrRenderAttr("datetime", datetime.value)} data-slot="date" class="${ssrRenderClass(ui.value.date({ class: unref(uiProp)?.date }))}"${_scopeId}>`);
              ...
              if (__props.title || !!slots.title) {
                _push2(`<h2 data-slot="title" class="${ssrRenderClass(ui.value.title({ class: unref(uiProp)?.title }))}"${_scopeId}>`);
              ...
              if (__props.authors?.length || !!slots.authors) {
                _push2(`<div data-slot="authors" class="${ssrRenderClass(ui.value.authors({ class: unref(uiProp)?.authors }))}"${_scopeId}>`);
                ssrRenderSlot(_ctx.$slots, "authors", { ui: ui.value }, () => {
                  if (__props.authors?.length) {
                    ...
                    if (__props.authors.length > 1) {
                          ...
                          if (_push3) {
                            ...
                            ssrRenderList(__props.authors, (author, index) => {
                              _push3(ssrRenderComponent(_sfc_main$m, {
                                ...
                                "data-slot": "avatar",
                                class: ui.value.avatar({ class: unref(uiProp)?.avatar, to: !!author.to }),
                                raw: ""
                              }, {
                                default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                                  if (_push4) {
                                    _push4(ssrRenderComponent(_sfc_main$o, mergeProps({ ref_for: true }, author.avatar), null, _parent4, _scopeId3));
                                  } else {
                                    return [
                                      createVNode(_sfc_main$o, mergeProps({ ref_for: true }, author.avatar), null, 16)
                                    ];
                                  }
                                }),
                                _: 2
                      ...
                      _push2(ssrRenderComponent(_sfc_main$3, __props.authors[0], null, _parent2, _scopeId));
                    }
                    _push2(`<!--]-->`);
                  } else {
                    _push2(`<!---->`);
              ...
              createVNode("div", {
                ...
                renderSlot(_ctx.$slots, "body", {}, () => [
                  date.value || !!slots.date || (__props.badge || !!slots.badge) ? (openBlock(), createBlock("div", {
                    key: 0,
                    "data-slot": "meta",
                    class: ui.value.meta({ class: unref(uiProp)?.meta })
                  }, [
                    renderSlot(_ctx.$slots, "badge", {}, () => [
                      __props.badge ? (openBlock(), createBlock(_sfc_main$d, mergeProps({
                        key: 0,
                        color: "neutral",
                        variant: "subtle"
                      }, typeof __props.badge === "string" ? { label: __props.badge } : __props.badge, {
                    ...
                    date.value || !!slots.date ? (openBlock(), createBlock("time", {
                      ...
                      "data-slot": "date",
                      class: ui.value.date({ class: unref(uiProp)?.date })
                    }, [
                  ...
                  __props.authors?.length || !!slots.authors ? (openBlock(), createBlock("div", {
                    key: 3,
                    "data-slot": "authors",
                    class: ui.value.authors({ class: unref(uiProp)?.authors })
                  }, [
                    renderSlot(_ctx.$slots, "authors", { ui: ui.value }, () => [
                      __props.authors?.length ? (openBlock(), createBlock(Fragment, { key: 0 }, [
                        __props.authors.length > 1 ? (openBlock(), createBlock(_sfc_main$2, { key: 0 }, {
                          default: withCtx(() => [
                            (openBlock(true), createBlock(Fragment, null, renderList(__props.authors, (author, index) => {
                              return openBlock(), createBlock(_sfc_main$m, {
                                key: index,
                          ...
                          _: 1
                        })) : (openBlock(), createBlock(_sfc_main$3, mergeProps({ key: 1 }, __props.authors[0]), null, 16))
...
//# sourceMappingURL=BlogPosts-Rb_sL5nt.mjs.map
