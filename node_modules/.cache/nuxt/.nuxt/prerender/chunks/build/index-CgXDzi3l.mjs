import { defineComponent, h, computed, ref, useAttrs, getCurrentInstance, Comment, mergeProps, cloneVNode, inject, provide, watch } from 'file:///Users/deim/Documents/project-viet/deim-portfolio/node_modules/vue/index.mjs';
import { warning as warning$1, invariant as invariant$1 } from 'file:///Users/deim/Documents/project-viet/deim-portfolio/node_modules/hey-listen/dist/index.js';
import { a8 as isDef } from './server.mjs';
...
function createStyles(keyframes2) {
  ...
  for (let key in keyframes2) {
    ...
    if (definition) {
      initialKeyframe = isNumber$1(value) ? (_a2 = definition.toDefaultUnit) == null ? void 0 : _a2.call(definition, value) : value;
...
class PanSession {
   ...
   */
  isScrollable(node) {
    const style2 = (void 0).getComputedStyle(node);
  ...
  startScrollTracking(element) {
    ...
    (void 0).addEventListener("scroll", this.onWindowScroll, {
      passive: true
    });
    this.removeScrollListeners = () => {
      (void 0).removeEventListener("scroll", this.onElementScroll, {
        capture: true
      });
  ...
  handleScroll(target) {
    ...
    const current = isWindow ? { x: (void 0).scrollX, y: (void 0).scrollY } : {
      x: target.scrollLeft,
      y: target.scrollTop
    };
...
export { Motion as M, PRESENCE_CHILD_ATTR as P, frame as f, mountedStates as m, provideAnimatePresence as p, useMotionConfig as u };
//# sourceMappingURL=index-CgXDzi3l.mjs.map
