import { mergeProps, unref, computed, withAsyncContext, watch, useSSRContext } from 'file:///Users/deim/Documents/project-viet/deim-portfolio/node_modules/vue/index.mjs';
...
import { useForwardProps } from 'file:///Users/deim/Documents/project-viet/deim-portfolio/node_modules/reka-ui/dist/index.js';
import { M as reactiveOmit, n as _sfc_main$o, G as useAsyncData } from './server.mjs';
import { M as MDCRenderer } from './MDCRenderer-B0MDmNtL.mjs';
...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    const { data, refresh, error } = ([__temp, __restore] = withAsyncContext(async () => useAsyncData(key.value, async () => {
      ...
      const { parseMarkdown } = await import('./index-Dzkb0eay.mjs');
...
//# sourceMappingURL=MDC-CMqqVl_J.mjs.map
