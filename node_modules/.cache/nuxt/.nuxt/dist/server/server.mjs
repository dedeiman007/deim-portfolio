import { hasInjectionContext, getCurrentInstance, shallowReactive, reactive, effectScope, getCurrentScope, inject, toRef as toRef$1, shallowRef, isReadonly, defineComponent, createElementBlock, provide, cloneVNode, h, computed, toValue, onServerPrefetch, ref, nextTick, unref, isRef, resolveComponent, isShallow, isReactive, toRaw, defineAsyncComponent, toRefs, readonly, customRef, watch, shallowReadonly, onScopeDispose, watchEffect, mergeProps, createVNode, resolveDynamicComponent, useSSRContext, useAttrs, useTemplateRef, useModel, withCtx, renderSlot, openBlock, createBlock, createTextVNode, toDisplayString, createCommentVNode, mergeModels, useSlots, Fragment, renderList, withModifiers, markRaw, useId, Suspense, withAsyncContext, toHandlers, onErrorCaptured, createApp } from "vue";
import { $fetch as $fetch$1 } from "/Users/deim/Documents/project-viet/deim-portfolio/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "/Users/deim/Documents/project-viet/deim-portfolio/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "/Users/deim/Documents/project-viet/deim-portfolio/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1, appendHeader, getRequestHeaders } from "/Users/deim/Documents/project-viet/deim-portfolio/node_modules/h3/dist/index.mjs";
import { parseURL, encodePath, decodePath, withQuery, hasProtocol, isScriptProtocol, joinURL, parseQuery, withTrailingSlash, withoutTrailingSlash, withLeadingSlash, withBase, withoutBase, encodeParam } from "/Users/deim/Documents/project-viet/deim-portfolio/node_modules/ufo/dist/index.mjs";
import { START_LOCATION, createMemoryHistory, createRouter, RouterView } from "vue-router";
import defu$1, { defu, defuFn } from "/Users/deim/Documents/project-viet/deim-portfolio/node_modules/defu/dist/defu.mjs";
import { klona } from "/Users/deim/Documents/project-viet/deim-portfolio/node_modules/klona/dist/index.mjs";
import { stringify, parse } from "/Users/deim/Documents/project-viet/deim-portfolio/node_modules/devalue/index.js";
import { toRouteMatcher, createRouter as createRouter$1 } from "/Users/deim/Documents/project-viet/deim-portfolio/node_modules/radix3/dist/index.mjs";
import { useHead as useHead$1, headSymbol, useSeoMeta as useSeoMeta$1, resolveUnrefHeadInput } from "/Users/deim/Documents/project-viet/deim-portfolio/node_modules/@unhead/vue/dist/index.mjs";
...
import { createContext, useForwardProps, Primitive, Slot, useForwardPropsEmits, ProgressRoot, ProgressIndicator, ToastRoot, ToastTitle, ToastDescription, ToastAction, ToastClose, ToastProvider, ToastPortal, ToastViewport, ConfigProvider, TooltipProvider, TooltipRoot, TooltipTrigger, TooltipPortal, TooltipContent, TooltipArrow, AccordionTrigger, AccordionItem, NavigationMenuItem, NavigationMenuTrigger, NavigationMenuLink, NavigationMenuContent, AccordionContent, AccordionRoot, NavigationMenuRoot, NavigationMenuList, NavigationMenuIndicator, NavigationMenuViewport } from "reka-ui";
import { createTV } from "tailwind-variants";
import { getIconCSS } from "@iconify/utils/lib/css/icon";
import { debounce } from "/Users/deim/Documents/project-viet/deim-portfolio/node_modules/perfect-debounce/dist/index.mjs";
import { diff, isEqual } from "ohash/utils";
import { pascalCase } from "/Users/deim/Documents/project-viet/deim-portfolio/node_modules/scule/dist/index.mjs";
...
const _routes = [
  {
    name: "about",
    path: "/about",
    component: () => import("./_nuxt/about-DGEUmhjg.js")
  },
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-BnX8PKoC.js")
  },
  {
    name: "projects",
    path: "/projects",
    component: () => import("./_nuxt/projects-DGIbUjUg.js")
  },
  {
    name: "speaking",
    path: "/speaking",
    component: () => import("./_nuxt/speaking-D9P0xw53.js")
  },
  {
    name: "blog",
    path: "/blog",
    component: () => import("./_nuxt/index-CNhsM0Gx.js")
  },
  {
    name: "blog-slug",
    path: "/blog/:slug(.*)*",
    component: () => import("./_nuxt/_...slug_-08ogWlLj.js")
  }
];
...
const LazyProseA = defineAsyncComponent(() => import("./_nuxt/A-a2Rxiuw-.js").then((r) => r["default"] || r.default || r));
const LazyProseAccordion = defineAsyncComponent(() => import("./_nuxt/Accordion-BJyMWf_q.js").then((r) => r["default"] || r.default || r));
const LazyProseAccordionItem = defineAsyncComponent(() => import("./_nuxt/AccordionItem-7yS544jU.js").then((r) => r["default"] || r.default || r));
const LazyProseBadge = defineAsyncComponent(() => import("./_nuxt/Badge-Bl6nJene.js").then((r) => r["default"] || r.default || r));
const LazyProseBlockquote = defineAsyncComponent(() => import("./_nuxt/Blockquote-CyAsn7Jk.js").then((r) => r["default"] || r.default || r));
const LazyProseCallout = defineAsyncComponent(() => import("./_nuxt/Callout-CXsneVGe.js").then((r) => r["default"] || r.default || r));
const LazyProseCard = defineAsyncComponent(() => import("./_nuxt/Card-DxMj6m1K.js").then((r) => r["default"] || r.default || r));
const LazyProseCardGroup = defineAsyncComponent(() => import("./_nuxt/CardGroup-CkOK8bQu.js").then((r) => r["default"] || r.default || r));
const LazyProseCode = defineAsyncComponent(() => import("./_nuxt/Code-DhHLiIhs.js").then((r) => r["default"] || r.default || r));
const LazyProseCodeCollapse = defineAsyncComponent(() => import("./_nuxt/CodeCollapse-D0r_U4dD.js").then((r) => r["default"] || r.default || r));
const LazyProseCodeGroup = defineAsyncComponent(() => import("./_nuxt/CodeGroup-DBR4ln82.js").then((r) => r["default"] || r.default || r));
const LazyProseCodeIcon = defineAsyncComponent(() => import("./_nuxt/CodeIcon-CIWnVkhY.js").then((r) => r["default"] || r.default || r));
const LazyProseCodePreview = defineAsyncComponent(() => import("./_nuxt/CodePreview-CdVgXHpq.js").then((r) => r["default"] || r.default || r));
const LazyProseCodeTree = defineAsyncComponent(() => import("./_nuxt/CodeTree-DAQX1a3Y.js").then((r) => r["default"] || r.default || r));
const LazyProseCollapsible = defineAsyncComponent(() => import("./_nuxt/Collapsible-DmRk2roj.js").then((r) => r["default"] || r.default || r));
const LazyProseEm = defineAsyncComponent(() => import("./_nuxt/Em-CTBGqG8i.js").then((r) => r["default"] || r.default || r));
const LazyProseField = defineAsyncComponent(() => import("./_nuxt/Field-CHcrbF8S.js").then((r) => r["default"] || r.default || r));
const LazyProseFieldGroup = defineAsyncComponent(() => import("./_nuxt/FieldGroup-BBwf_mi0.js").then((r) => r["default"] || r.default || r));
const LazyProseH1 = defineAsyncComponent(() => import("./_nuxt/H1-Cb_LRvqW.js").then((r) => r["default"] || r.default || r));
const LazyProseH2 = defineAsyncComponent(() => import("./_nuxt/H2-zAl72cpf.js").then((r) => r["default"] || r.default || r));
const LazyProseH3 = defineAsyncComponent(() => import("./_nuxt/H3-B7p-UZuv.js").then((r) => r["default"] || r.default || r));
const LazyProseH4 = defineAsyncComponent(() => import("./_nuxt/H4-DEmu_RL_.js").then((r) => r["default"] || r.default || r));
const LazyProseHr = defineAsyncComponent(() => import("./_nuxt/Hr-DchKKo31.js").then((r) => r["default"] || r.default || r));
const LazyProseIcon = defineAsyncComponent(() => import("./_nuxt/Icon-r0f8b0Nb.js").then((r) => r["default"] || r.default || r));
const LazyProseImg = defineAsyncComponent(() => import("./_nuxt/Img-B_gIBqp6.js").then((r) => r["default"] || r.default || r));
const LazyProseKbd = defineAsyncComponent(() => import("./_nuxt/Kbd-DDKUJbUQ.js").then((r) => r["default"] || r.default || r));
const LazyProseLi = defineAsyncComponent(() => import("./_nuxt/Li-fddIzbeB.js").then((r) => r["default"] || r.default || r));
const LazyProseOl = defineAsyncComponent(() => import("./_nuxt/Ol-BMudMcMv.js").then((r) => r["default"] || r.default || r));
const LazyProseP = defineAsyncComponent(() => import("./_nuxt/P-DqwWfGIR.js").then((r) => r["default"] || r.default || r));
const LazyProsePre = defineAsyncComponent(() => import("./_nuxt/Pre-DlW7Xnqv.js").then((r) => r["default"] || r.default || r));
const LazyProseScript = defineAsyncComponent(() => import("./_nuxt/Script-BOX32BRp.js").then((r) => r["default"] || r.default || r));
const LazyProseSteps = defineAsyncComponent(() => import("./_nuxt/Steps-Buyg-wtu.js").then((r) => r["default"] || r.default || r));
const LazyProseStrong = defineAsyncComponent(() => import("./_nuxt/Strong-YQ3pVKcm.js").then((r) => r["default"] || r.default || r));
const LazyProseTable = defineAsyncComponent(() => import("./_nuxt/Table-BiGGoQfn.js").then((r) => r["default"] || r.default || r));
const LazyProseTabs = defineAsyncComponent(() => import("./_nuxt/Tabs-DKF6C2Wt.js").then((r) => r["default"] || r.default || r));
const LazyProseTabsItem = defineAsyncComponent(() => import("./_nuxt/TabsItem-lWqMlpqE.js").then((r) => r["default"] || r.default || r));
const LazyProseTbody = defineAsyncComponent(() => import("./_nuxt/Tbody-BUIhzzRX.js").then((r) => r["default"] || r.default || r));
const LazyProseTd = defineAsyncComponent(() => import("./_nuxt/Td-VF8Vd_6J.js").then((r) => r["default"] || r.default || r));
const LazyProseTh = defineAsyncComponent(() => import("./_nuxt/Th-CKgwrUal.js").then((r) => r["default"] || r.default || r));
const LazyProseThead = defineAsyncComponent(() => import("./_nuxt/Thead-CQgV3DAF.js").then((r) => r["default"] || r.default || r));
const LazyProseTr = defineAsyncComponent(() => import("./_nuxt/Tr-Bw6X2Y4N.js").then((r) => r["default"] || r.default || r));
const LazyProseUl = defineAsyncComponent(() => import("./_nuxt/Ul-iA4hPUgM.js").then((r) => r["default"] || r.default || r));
const LazyProseCaution = defineAsyncComponent(() => import("./_nuxt/Caution-DG-MUQnB.js").then((r) => r["default"] || r.default || r));
const LazyProseNote = defineAsyncComponent(() => import("./_nuxt/Note-yHQZ10EX.js").then((r) => r["default"] || r.default || r));
const LazyProseTip = defineAsyncComponent(() => import("./_nuxt/Tip-KS4Exiow.js").then((r) => r["default"] || r.default || r));
const LazyProseWarning = defineAsyncComponent(() => import("./_nuxt/Warning-2n-ckBMP.js").then((r) => r["default"] || r.default || r));
const LazyProseH5 = defineAsyncComponent(() => import("./_nuxt/ProseH5-DaqwBDMT.js").then((r) => r["default"] || r.default || r));
const LazyProseH6 = defineAsyncComponent(() => import("./_nuxt/ProseH6-BISdFwJd.js").then((r) => r["default"] || r.default || r));
...
const __nuxt_component_4_lazy = defineAsyncComponent(() => import("./_nuxt/ContentSearch-Frqjb070.js").then((c) => c.default || c));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = defineAsyncComponent(() => import("./_nuxt/island-renderer-Q_HKScM7.js").then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
    nuxtApp.deferHydration();
...
export {
  ...
  useActiveElement as D,
  useColorMode as E,
  transformUI as F,
  useAsyncData as G,
  queryCollection as H,
  useSeoMeta as I,
  _sfc_main$5 as J,
  ImageComponent as K,
  _sfc_main$6 as L,
  reactiveOmit as M,
  pausableFilter as N,
  useMouseInElement as O,
  getSlotChildrenText as P,
  __nuxt_component_5 as Q,
  avatarGroupInjectionKey as R,
  _sfc_main$d as S,
  ...
  setHeadOgImagePrebuilt as Y,
  getOgImagePath as Z,
  _sfc_main$l as _,
  createSharedComposable as a,
  createOgImageMeta as a0,
  queryCollectionItemSurroundings as a1,
  _sfc_main$f as a2,
  PageRouteSymbol as a3,
  appLayoutTransition as a4,
  _wrapInTransition as a5,
  _routeRulesMatcher as a6,
  LayoutMetaSymbol as a7,
  isDef as a8,
  resolveBaseURL as a9,
  useClipboard as aa,
  __nuxt_component_0$1 as ab,
  useSiteConfig as ac,
  __nuxt_component_1 as ad,
  navLinks as ae,
  __nuxt_component_2 as af,
  useLocale as b,
  createError as c,
  useComponentUI as d,
