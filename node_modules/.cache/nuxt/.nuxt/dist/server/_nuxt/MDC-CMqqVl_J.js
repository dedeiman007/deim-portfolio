import { mergeProps, unref, useSSRContext, computed, withAsyncContext, watch } from "vue";
import { ssrRenderComponent, ssrRenderSlot } from "vue/server-renderer";
import { useForwardProps } from "reka-ui";
import { M as reactiveOmit, n as _sfc_main$2, G as useAsyncData } from "../server.mjs";
import { M as MDCRenderer } from "./MDCRenderer-B0MDmNtL.js";
...
const _sfc_main$1 = /* @__PURE__ */ Object.assign({ inheritAttrs: false }, {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<!--[-->`);
      _push(ssrRenderComponent(_sfc_main$2, mergeProps({ ...unref(avatarProps), ..._ctx.$attrs }, {
        src: __props.light,
        class: "dark:hidden"
      }), null, _parent));
      _push(ssrRenderComponent(_sfc_main$2, mergeProps({ ...unref(avatarProps), ..._ctx.$attrs }, {
...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    const { data, refresh, error } = ([__temp, __restore] = withAsyncContext(async () => useAsyncData(key.value, async () => {
      ...
      const { parseMarkdown } = await import("./index-Dzkb0eay.js");
...
//# sourceMappingURL=MDC-CMqqVl_J.js.map
