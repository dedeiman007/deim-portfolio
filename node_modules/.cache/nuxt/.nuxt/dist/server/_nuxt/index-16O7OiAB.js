import { useSlots, computed, unref, mergeProps, withCtx, openBlock, createBlock, renderSlot, createTextVNode, toDisplayString, createCommentVNode, Fragment, renderList, createVNode, useSSRContext } from "/Users/deim/Documents/project-viet/deim-portfolio/node_modules/vue/index.mjs";
...
import { b as useAppConfig, c as useComponentUI, t as tv, d as _sfc_main$5, e as _sfc_main$6, g as getSlotChildrenText, f as _sfc_main$7, h as _sfc_main$8, _ as _export_sfc } from "../server.mjs";
      ...
      _push(ssrRenderComponent(unref(Primitive), mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (__props.to) {
              _push2(ssrRenderComponent(_sfc_main$8, mergeProps({ "aria-label": ariaLabel.value }, { to: __props.to, target: __props.target, ..._ctx.$attrs }, {
            ...
            return [
              ...
              createVNode("div", {
                ...
                __props.to ? (openBlock(), createBlock(_sfc_main$8, mergeProps({
                  key: 0,
...
//# sourceMappingURL=index-16O7OiAB.js.map
