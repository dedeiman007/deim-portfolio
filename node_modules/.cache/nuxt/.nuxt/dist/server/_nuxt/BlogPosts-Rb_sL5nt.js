import { useSlots, computed, provide, unref, mergeProps, withCtx, createVNode, resolveDynamicComponent, openBlock, createBlock, createCommentVNode, Fragment, renderList, useSSRContext, renderSlot, createTextVNode, toDisplayString, createSlots } from "vue";
import { ssrRenderComponent, ssrRenderList, ssrRenderVNode, ssrRenderClass, ssrRenderSlot, ssrRenderAttr, ssrInterpolate } from "vue/server-renderer";
import { Primitive, useDateFormatter } from "reka-ui";
import { u as useAppConfig, d as useComponentUI, t as tv, R as avatarGroupInjectionKey, n as _sfc_main$3, b as useLocale, P as getSlotChildrenText, K as ImageComponent, s as _sfc_main$4, S as _sfc_main$5, w as omit } from "../server.mjs";
import { _ as _sfc_main$6 } from "./User-DdYik7A4.js";
const theme$2 = {
  "slots": {
      ...
      _push(ssrRenderComponent(unref(Primitive), mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [
              hiddenCount.value > 0 ? (openBlock(), createBlock(_sfc_main$3, {
                key: 0,
                text: `+${hiddenCount.value}`,
                "data-slot": "base",
                class: ui.value.base({ class: unref(uiProp)?.base })
      ...
      _push(ssrRenderComponent(unref(Primitive), mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (__props.to) {
              _push2(ssrRenderComponent(_sfc_main$4, mergeProps({ "aria-label": ariaLabel.value }, { to: __props.to, target: __props.target, ..._ctx.$attrs }, {
                ...
                ssrRenderSlot(_ctx.$slots, "authors", { ui: ui.value }, () => {
                  if (__props.authors?.length) {
                    ...
                    if (__props.authors.length > 1) {
                            ...
                            ssrRenderList(__props.authors, (author, index) => {
                              _push3(ssrRenderComponent(_sfc_main$4, {
                                ...
                                default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                                  if (_push4) {
                                    _push4(ssrRenderComponent(_sfc_main$3, mergeProps({ ref_for: true }, author.avatar), null, _parent4, _scopeId3));
                                  } else {
                                    return [
                                      createVNode(_sfc_main$3, mergeProps({ ref_for: true }, author.avatar), null, 16)
                                    ];
                                  }
                                }),
                                _: 2
                      ...
                      _push2(ssrRenderComponent(_sfc_main$6, __props.authors[0], null, _parent2, _scopeId));
                    }
                    _push2(`<!--]-->`);
                  } else {
                    _push2(`<!---->`);
            ...
            return [
              ...
              createVNode("div", {
                ...
                __props.to ? (openBlock(), createBlock(_sfc_main$4, mergeProps({
                  key: 0,
                ...
                renderSlot(_ctx.$slots, "body", {}, () => [
                  date.value || !!slots.date || (__props.badge || !!slots.badge) ? (openBlock(), createBlock("div", {
                    ...
                    renderSlot(_ctx.$slots, "badge", {}, () => [
                      __props.badge ? (openBlock(), createBlock(_sfc_main$5, mergeProps({
                        key: 0,
                        color: "neutral",
                        variant: "subtle"
                      }, typeof __props.badge === "string" ? { label: __props.badge } : __props.badge, {
                    ...
                    renderSlot(_ctx.$slots, "authors", { ui: ui.value }, () => [
                      __props.authors?.length ? (openBlock(), createBlock(Fragment, { key: 0 }, [
                        __props.authors.length > 1 ? (openBlock(), createBlock(_sfc_main$2, { key: 0 }, {
                          ...
                          _: 1
                        })) : (openBlock(), createBlock(_sfc_main$6, mergeProps({ key: 1 }, __props.authors[0]), null, 16))
...
//# sourceMappingURL=BlogPosts-Rb_sL5nt.js.map
